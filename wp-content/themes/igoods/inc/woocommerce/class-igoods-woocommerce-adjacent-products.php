<?php
/**
 * Igoods WooCommerce Adjacent Products Class
 *
 * @package  igoods
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Igoods_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Igoods WooCommerce Adjacent Products Class
	 */
	class Igoods_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'igoods_woocommerce_adjacent_query_args', $args ) );
