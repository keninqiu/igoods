...
if ( ! class_exists( 'Igoods_WooCommerce' ) ) :

	/**
	 * The Igoods WooCommerce Integration class
	 */
	class Igoods_WooCommerce {
		...
		public function __construct() {
			...
			// Integrations.
			add_action( 'igoods_woocommerce_setup', array( $this, 'setup_integrations' ) );
		...
		public function setup() {
			...
			/**
			 * Add 'igoods_woocommerce_setup' action.
			 *
			 * @since  2.4.0
			 */
			do_action( 'igoods_woocommerce_setup' );
		}
		...
		public function add_customizer_css() {
			wp_add_inline_style( 'igoods-woocommerce-style', $this->get_woocommerce_extension_css() );
		}
		...
		public function woocommerce_scripts() {
			...
			wp_style_add_data( 'igoods-woocommerce-style', 'rtl', 'replace' );

			wp_register_script( 'igoods-header-cart', get_template_directory_uri() . '/assets/js/woocommerce/header-cart' . $suffix . '.js', array(), $igoods_version, true );
			wp_enqueue_script( 'igoods-header-cart' );

			if ( ! class_exists( 'igoods_Sticky_Add_to_Cart' ) && is_product() ) {
				wp_register_script( 'igoods-sticky-add-to-cart', get_template_directory_uri() . '/assets/js/sticky-add-to-cart' . $suffix . '.js', array(), $igoods_version, true );
			}

			if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '3.3', '<' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-legacy', get_template_directory_uri() . '/assets/css/woocommerce/woocommerce-legacy.css', array(), $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-legacy', 'rtl', 'replace' );
			}
		}
		...
		public function related_products_args( $args ) {
			$args = apply_filters(
				'igoods_related_products_args', array(
					'posts_per_page' => 3,
					'columns'        => 3,
				)
			);
		...
		public function thumbnail_columns() {
			...
			return intval( apply_filters( 'igoods_product_thumbnail_columns', $columns ) );
		}
		...
		public function products_per_page() {
			return intval( apply_filters( 'igoods_products_per_page', 12 ) );
		}
		...
		public function change_breadcrumb_delimiter( $defaults ) {
			...
			$defaults['wrap_before'] = '<div class="igoods-breadcrumb"><div class="col-full"><nav class="woocommerce-breadcrumb">';
		...
		public function woocommerce_integrations_scripts() {
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Bookings' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-bookings-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/bookings.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-bookings-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Brands' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-brands-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/brands.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-brands-style', 'rtl', 'replace' );

				wp_enqueue_script( 'igoods-woocommerce-brands', get_template_directory_uri() . '/assets/js/woocommerce/extensions/brands' . $suffix . '.js', array(), $igoods_version, true );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Wishlists_Wishlist' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-wishlists-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/wishlists.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-wishlists-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'SOD_Widget_Ajax_Layered_Nav' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-ajax-layered-nav-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/ajax-layered-nav.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-ajax-layered-nav-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_SwatchesPlugin' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-variation-swatches-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/variation-swatches.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-variation-swatches-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Composite_Products' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-composite-products-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/composite-products.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-composite-products-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Photography' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-photography-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/photography.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-photography-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Product_Reviews_Pro' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-product-reviews-pro-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/product-reviews-pro.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-product-reviews-pro-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Smart_Coupons' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-smart-coupons-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/smart-coupons.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-smart-coupons-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Deposits' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-deposits-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/deposits.css', 'storefront-woocommerce-style', $storefront_version );
				wp_style_add_data( 'igoods-woocommerce-deposits-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Bundles' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-bundles-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/bundles.css', 'igoods-woocommerce-style', $storefront_version );
				wp_style_add_data( 'igoods-woocommerce-bundles-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'WC_Ship_Multiple' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-sma-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/ship-multiple-addresses.css', 'igoods-woocommerce-style', $igoods_version );
				wp_style_add_data( 'igoods-woocommerce-sma-style', 'rtl', 'replace' );
			}
			...
			if ( $this->is_woocommerce_extension_activated( 'Woocommerce_Advanced_Product_Labels' ) ) {
				wp_enqueue_style( 'igoods-woocommerce-apl-style', get_template_directory_uri() . '/assets/css/woocommerce/extensions/advanced-product-labels.css', 'igoods-woocommerce-style', $igoods_version );
