...
class __TwigTemplate_4de836a578c88c4e9f5c07f49a3c255f4afa1710d2950e1802b99be25240ec81 extends Twig_Template
{
...
<ul class=\"no-bullets\">
    <li>
        ...
        echo " />
            ";
        // line 10
        echo $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "label_display_as_translated", array());
        echo "
        </label>
    </li>
    <li>
        <label class=\"display-as-translated-no\">
            ...
            ";
        // line 16
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "label_translated", array()), "html", null, true);
        echo "
        </label>
    </li>
</ul>
...
<p>";
        // line 21
        echo sprintf($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "description_footer", array()), "<strong>", "</strong>");
        echo "</p>
...
<p class=\"wcml-setup-actions step\">
    ...
    {
        return new Twig_Source("", "/setup/translation-options.twig", "/home/bitnami/website/igoods/wp-content/plugins/woocommerce-multilingual/templates/setup/translation-options.twig");
    }
}
