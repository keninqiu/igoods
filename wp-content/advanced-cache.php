...
$rocket_cache_path  = '/Library/WebServer/Documents/igoods/wp-content/cache/wp-rocket/';
$rocket_config_path = '/Library/WebServer/Documents/igoods/wp-content/wp-rocket-config/';

if ( file_exists( '/Library/WebServer/Documents/igoods/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/Library/WebServer/Documents/igoods/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
	...
	include '/Library/WebServer/Documents/igoods/wp-content/plugins/wp-rocket/inc/front/process.php';
} else {
