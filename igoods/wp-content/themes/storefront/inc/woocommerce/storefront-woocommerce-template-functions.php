...
if ( ! function_exists( 'storefront_cart_link' ) ) {
	...
	function storefront_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart1', 'storefront' ); ?>">
...
if ( ! function_exists( 'storefront_handheld_footer_bar_cart_link' ) ) {
	...
	function storefront_handheld_footer_bar_cart_link() {
		?>
			<a class="footer-cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart2', 'storefront' ); ?>">
