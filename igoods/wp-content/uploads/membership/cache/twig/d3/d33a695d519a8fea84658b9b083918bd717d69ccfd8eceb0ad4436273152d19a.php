    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (($this->getAttribute(($context["activity"] ?? null), "type", array()) == "follow")) {
            ...
            if ($this->env->getExtension('Membership_Users_Twig')->isCurrentUser($this->getAttribute(($context["activity"] ?? null), "target", array()))) {
                // line 3
                echo "\t\t";
                echo sprintf(call_user_func_array($this->env->getFunction('translate')->getCallable(), array("%s is now following you")), (((("<a href=\"" . $this->env->getExtension('Membership_Users_Twig')->profileUrl($this->getAttribute(                // line 5
...
\t";
                ...
                // line 8
                echo "\t\t";
                echo sprintf(call_user_func_array($this->env->getFunction('translate')->getCallable(), array("%s is now following %s")), (((("<a href=\"" . $this->env->getExtension('Membership_Users_Twig')->profileUrl($this->getAttribute(                // line 10
...
\t";
            // line 19
            echo sprintf(call_user_func_array($this->env->getFunction('translate')->getCallable(), array("%s and %s became friends")), (((("<a href=\"" . $this->env->getExtension('Membership_Users_Twig')->profileUrl($this->getAttribute(            // line 21
...
";
    ...
    {
        return new Twig_Source("", "@users/partials/activity-title.twig", "/Library/WebServer/Documents/igoods/wp-content/plugins/membership-by-supsystic/src/Membership/Users/views/partials/activity-title.twig");
    }
}
